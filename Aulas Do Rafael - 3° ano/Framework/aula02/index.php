...
<head>
    ...
    <title>Exercicios Aprendizado I - HTML com PHP</title>
...
<body class="bg-info-subtle">
    <div class="card w-50 mx-auto mt-3">
        <div class="card-body">
            <h5 class="card-title text-center">Exercicios Aprendizado I - HTML com PHP</h5>
            <div class="list-group">
                <a href="ex01.php" class="list-group-item list-group-item-action">Exemplo 01 - Comprimento do fio</a>
                <a href="#" class="list-group-item list-group-item-action">Exemplo 02 - Tabuada</a>
