...
<div class="card mx-auto mt-5 w-50">
  <div class="card-body">
    <h5 class="card-title text-center">Camparar Números</h5>

    <p class="card-text" style="text-align: justify">Escreva dois números quaisquer:</p>
    
        
        <div class="row">
            <div class="col-md-4">
                <label for="n1" class="form">Número 1:</label>
                <input name="cpNum1" type="text" class="form-control" id="Input01">
            </div>
            <div class="col-md-4">
                <label for="n2" class="form">Número 2:</label>
...
<table class="table table-bordered table-info w-50 mx-auto mt-4">
        ...
        <tbody>
                ...
                <?php if (empty($_GET)){ ?>
                    ...
                    if($num2>$num1)
                        echo $num2.' é maior e '.$num1.' é menor.'; 
